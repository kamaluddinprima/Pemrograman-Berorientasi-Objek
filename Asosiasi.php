<?php 
 ...
 class Mahasiswa { 
    ...
    public function Mahasiswa(String $nama, int $nomorID){ 
        $this->nama = $nama; 
...
class TestAsosiasi { 
    public static function main() { 
        ...
        $jurusan = new Jurusan(); 
        $mahasiswa->setJurusan("Nesta");
        $jurusan->setMahasiswa("MIPA"); 
        
        echo "Nama: " . $mahasiswa->getNama() ."<br>". "ID: " . $mahasiswa->getNomorID() ."<br>" . 
